...
{	
	...
	static string ZoneEnterMsg = "Вы вошли в зону миссии!";
	static string TimeLeftMsg = " минут до окончания миссии.";	//keep first character as space
	static string ZoneLeaveMsg = "Вы покинули зону миссии!";	
	static string StartingMsg = "Кто-нибудь меня слышит?";	//(Message 0)
	static string TargetFoundMsg = "Вы нашли цель!";
	static string Message3Ext = " минут осталось. Конец связи!";		//keep first character as space
	static string FinishingMsg = "Спасибо выжившему за решение этой проблемы.\nЯ позвоню вам для дальнейших заданий по этому радиоканалу.\nКонец связи!";	//(Message -1)
	static string TimeoutMsg = "Извините, но вы опоздали!\nЯ позвоню вам для дальнейших задач по этому радиоканалу.\nКонец связи!";	//(Message -2)
